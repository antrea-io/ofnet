...
func TestNewFlowActionAPIs(t *testing.T) {
	...
	ctZoneField, _ := openflow13.FindFieldHeaderByName("NXM_NX_REG1", false)
	ctZoneRange := openflow13.NewNXRange(0, 15)
	natAction0 := openflow13.NewNXActionCTNAT()
	conntrack2 := NewZoneRangeNXConnTrackAction(false, false, &ctTable, ctZoneField, ctZoneRange, natAction0)
